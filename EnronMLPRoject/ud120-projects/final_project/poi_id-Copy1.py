...
features_list = ['poi','salary', 'total_payments', 'restricted_stock_deferred', 'expenses', 'exercised_stock_options', 'long_term_incentive', 'restricted_stock',  'from_poi_to_this_person', 'from_this_person_to_poi'] # You will need to use more features
...
pipeline_GNB = Pipeline([("scaler",min_max_scaler),('feature_sel',combined),('gnb',clf)])
